          ...
          {(!PLANNER_API_URL || failed) && (
            <View style={styles.noticeBox}>
              ...
              <View style={styles.flex}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('TravelStyle', { mode: 'manual' })}>
          ...
          {result ? (
            <>
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate('SpotSelect', { settings: result.settings, mode: 'auto' })}
                activeOpacity={0.85}
              >
              ...
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate('DetailCondition', { settings: result.settings, mode: 'auto' })}
              >
